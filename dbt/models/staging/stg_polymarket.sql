-- Staging: Polymarket quotes (data-only consensus source).
-- Same shape as the other staging models; filtered to source='polymarket'.
-- implied_prob is the "Yes" share price; NaN becomes NULL.
